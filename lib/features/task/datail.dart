...
import 'package:unitaskpro/features/shared/widget/stretchy_header.dart';

@immutable
class TaskDetailPage extends ConsumerWidget {
  const TaskDetailPage({super.key, required this.taskModel, this.keys});
  ...
  Widget build(BuildContext context, ref) {
    ...
    var task = asyncValue.getcurrentTask(keys, taskModel);
            ...
            : [
                IconButton(
                    onPressed: () {
                      ...
                      asyncValue.updateTask(keys, copyWith);
                    },
                      ...
                      var child = Container(
                        ...
                        child: Column(children: [
                          RowItemWidget(
                            ...
                            onTap: () {
                              var child = BcWidget(taskModel: task, keys: keys);
                              showSheet(context, child: child);
                            },
                          ),
                          RowItemWidget(
                              onTap: () {
                                asyncValue.removeTask(keys, taskModel);
...
class BcWidget extends ConsumerWidget {
  const BcWidget({super.key, required this.taskModel, required this.keys});
  final TaskModel taskModel;
  final dynamic keys;
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          ...
                          provider.updateTask(keys, taskModel.copyWith(img: e));
